...
กำหนดสามเหลี่ยมมุมฉากดังรูปที่~\ref{Figure14} จงหาความยาว $x$
...
กำหนดสามเหลี่ยมมุมฉากดังรูปที่~\ref{Figure15} จงหาความยาวด้าน $BC$
\begin{multicols}{2} \begin{enumerate}
\item $3$
\item $3\sqrt{2}$
\item $4$
...
กำหนดสามเหลี่ยมมุมฉากดังรูปที่~\ref{Figure13} จงหาความยาว $x$
\begin{multicols}{2} \begin{enumerate}
\item $2$
\item $6$
\item $2\sqrt{10}$
...
\end{figure} 
\newpage
จงใช้ข้อมูลตอบคำถามตัวอย่าง~\ref{example1.5} และ ตัวอย่าง~\ref{example1.6}
\begin{enumerate}
\item พับกระดาษรูปสี่เหลี่ยมผืนผ้าตามรอย $EF$ และคลี่กระดาษออก ดังรูปที่~\ref{Figure35}
\item พับอีกครั้งตรงมุม $A$ และพับตามรอย $E F$ รอยพับที่เกิดขึ้นคือเส้นตรง $E G$ ดังรูปที่~\ref{Figure36}
\item แสดงรอยพับทั้งหมดจากการคลี่กระดาษออกโดยที่ $E F B$ กาง $54^{\circ}$ ดังรูปที่~\ref{Figure37}
\end{enumerate} 
\begin{figure}[H]	 
	\centering
...
\begin{figure}[H]	 
	...
	\includegraphics[scale=0.6]{37}
       ...
       \label{Figure37}
\end{figure} 
\begin{examplebox}[NETSAT คณิตศาสตร์ กุมภาพันธ์ 2567] \label{example1.5}
จากรูปที่~\ref{Figure35} มุม $x$ มีขนาดเท่าใด
\begin{multicols}{2} \begin{enumerate}
\item $36^{\circ}$
\item $54^{\circ}$
\item $60^{\circ}$
...
\begin{examplebox}[NETSAT คณิตศาสตร์ กุมภาพันธ์ 2567] \label{example1.6}
จากรูปที่~\ref{Figure35} มุม $y$ มีขนาดเท่าใด
\begin{multicols}{2} \begin{enumerate}
\item $36^{\circ}$
\item $54^{\circ}$
\item $60^{\circ}$
...
จากรูปที่~\ref{Figure39} ข้อใดกล่าวถูกต้อง
\begin{multicols}{2} \begin{enumerate}
\item $MN// PR$
\item $NR// PQ$
\item $\angle NRP = 50^{\circ}$ 
